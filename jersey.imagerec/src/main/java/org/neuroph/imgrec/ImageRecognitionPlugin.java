...
/**
 * Provides image recognition specific properties like sampling resolution, and
 * easy to use image recognition interface for neural network.
 * 
 * @author Jon Tait
...
public class ImageRecognitionPlugin extends PluginBase implements Serializable {
	...
	public void setInput(Image img) throws ImageSizeMismatchException {
		FractionRgbData imgRgb = new FractionRgbData(ImageSampler.downSampleImage(samplingResolution, img,
		        img.getType()));
		double input[];
	...
	/**
	 * This method performs the image recognition for specified image. Returns
	 * image recognition result as map with image labels as keys and recogition
	 * result as value
	 * 
	 * @return image recognition result
	 */
	...
	// public HashMap<String, Double> recognizeImage(Bitmap img) throws
