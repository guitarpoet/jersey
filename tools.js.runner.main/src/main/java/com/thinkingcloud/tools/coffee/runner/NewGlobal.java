...
import com.thinkingcloud.tools.coffee.runner.functions.SimpleFunction;
...
public class NewGlobal extends Global {
	...
	public void init() {
		...
		for (SimpleFunction function : context.getBeansOfType(SimpleFunction.class).values()) {
			defineProperty(function.getName(), function, ScriptableObject.DONTENUM);
		}
	}
}
