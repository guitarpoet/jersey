package info.thinkingcloud.jersey.gui;
...
public class JConsole extends JComponent implements HierarchyListener {
	...
	private static final int DEFAULT_BLINKRATE = 500;
	private static final boolean DEFAULT_BLINK_ON = true;

	private ConsoleBuffer data = new ConsoleBuffer();
	...
	public void moveCursor(char c) {
		...
		case KeyEvent.VK_BACK_SPACE:
			data.setDataAt(cursorX, cursorY, ' ', currentForeground, currentBackground, currentFont);
