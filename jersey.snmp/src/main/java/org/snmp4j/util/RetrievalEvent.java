...
public abstract class RetrievalEvent extends EventObject {
	...
	private static final long serialVersionUID = -2157651901624133399L;
	/**
	...
	public String toString() {
		return getClass().getName() + "[vbs=" + ((vbs == null) ? "null" : "" + Arrays.asList(vbs)) + ",status="
		        + status + ",exception=" + exception + ",report=" + reportPDU + "]";
	}
