...
/**
 * The <code>DefaultCounterListener</code> is the default implementation of the
...
public class DefaultCounterListener implements CounterListener {
	 ...
	 * received already for the given <tt>oid</tt> the provided counter will be
	 * incremented by the number of events already counted and then
	 * <tt>counter</tt> replaces the old counter.
	 * 
	 * @param oid
